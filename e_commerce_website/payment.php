      ...
      <form action="action_page.php">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="fname" name="firstname" placeholder="lokesh s" required>
            <label for="email"><i class="fa fa-envelope"></i> Email*</label>
            <input type="text" id="email" name="email" placeholder="Sanjay@example.com" required>
          ...
          <div class="col-50">
            ...
            <input type="text" id="cname" name="cardname" placeholder="lokesh " required>
